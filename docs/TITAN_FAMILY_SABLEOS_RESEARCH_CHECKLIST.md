...
| Tier 2 L. Power / thermal / suspend | **PARTIAL — thermal/Health healthy; charging/idle closure remains** | Thermal HAL inventory/status and Health/battery evidence are captured; known keyboard/SubScreen wake behavior remains valid. The latest idle run stayed USB-powered at 100%, so natural unplugged deep idle and below-full charging progression remain unqualified; power-button wake, alternate charging and battery-health policy also remain to close. |
